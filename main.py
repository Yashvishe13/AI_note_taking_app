...
st.set_page_config(
        page_title="AI Note-taking app",
        page_icon="🧙‍♂️",
)

key = st.text_input("Enter GROQ_API_KEY")
if key:
    GROQ_API_KEY = key
    ...
    class GenerationStatistics:
        ...
        def __str__(self):
            return (f"\n##| Inference Time (s) | {self.input_time:.2f}            | {self.output_time:.2f}            | {self.total_time:.2f}            |")
    ...
    def generate_notes_structure(transcript: str, model: str = "llama-3.3-70b-versatile"):
        """
    ...
    try:
        with st.sidebar:
            ...
            st.write(f"By default, application uses uses llama-3.3-70b-versatile for generating the notes outline and llama-3.1-8b-instant for the content. You can customize these selections below.")
            outline_model_options = ["llama-3.3-70b-versatile", "distil-whisper-large-v3-en", "llama-3.1-8b-instant",  "llama3-70b-8192", "llama3-8b-8192", "mixtral-8x7b-32768"]
            outline_selected_model = st.selectbox("Outline generation:", outline_model_options)
            content_model_options = ["llama-3.1-8b-instant", "llama3-8b-8192", "llama3-70b-8192", "mixtral-8x7b-32768", "gemma-7b-it", "gemma2-9b-it"]
